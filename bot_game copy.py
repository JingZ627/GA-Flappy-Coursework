...
class game(object):
    ...
    def move(self):
        self.move_distance+=self.speed*0.05;
    ...
    def sense_target(self):
        for ball in self.balls:
            if self.bird.x < ball.x < 200 and self.bird+30 < ball.y < self.bird-30:
                return True 
            else: 
                continue
...
def create_toolbox():
    ...
    # pset.addPrimitive(robot.if_target_left, 2)
    # pset.addPrimitive(robot.if_target_right, 2)
    # pset.addPrimitive(robot.if_forward_better, 2)
    # pset.addPrimitive(robot.if_noOneLeft, 2)
    # pset.addPrimitive(robot.if_noOneRight, 2)
